...
public class Main {
	...
	public static void main(String[] args) {
		...
		Brave item1 = new Brave("沖田総司", "剣");
		Fighter item2 = new Fighter("金太郎", "斧");
		Wizard item3 = new Wizard("安倍晴明", "魔法");
		...
		Slime monster1 = new Slime("キングスライム", "体当たり");
		Oak monster2 = new Oak("オークキング", "槍");
		Dragon monster3 = new Dragon("紅龍", "炎");
		// モンスターグループのリストを空で生成
